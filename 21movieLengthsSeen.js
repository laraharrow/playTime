...
We could sort the movieLengths first—then we could use binary search ↴ to find secondMovieLength in O(\lg{n}) time instead of O(n) time. But sorting would cost O(nlg(n)), and we can do even better than that.
